...
# Charger le modèle
with open("modele_riz.pkl", "rb") as file:
    sarimax_riz = pickle.load(file)

# Interface utilisateur
st.title("Prédiction du rendement du riz")
...
if facteurs_climatiques:
    ...
    # Prédictions
    try:
        predictions = sarimax_riz.get_forecast(steps=annees_a_predire, exog=future_exog)
